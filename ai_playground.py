...
instance = dataDescriptor.generateData(classNumber=2, pointsNumber=20000)
...
train_and_save(model=model1, epoch_number=100, data=data,
               label=label, save_path='./models/1layer2602')
train_and_save(model=model2, epoch_number=100, data=data,
               label=label, save_path='./models/2layer2602')
train_and_save(model=model4, epoch_number=100, data=data,
               label=label, save_path='./models/4layer2602')
train_and_save(model=model8, epoch_number=250, data=data,
               label=label, save_path='./models/8layer2602')
train_and_save(model=model16, epoch_number=500, data=data,
               label=label, save_path='./models/16layer2602')
